...
function Navbar() {
    ...
    useEffect(() => {
        ...
        return (
            <>
                <div className={`max-w-screen-2xl container mx-auto md:px-20 px-4 fixed top-0 left-0 right-0 ${sticky ? "sticky-navbar shadow-md bg-base duration-300 transition-all ease-in-out" : ""}`}>
